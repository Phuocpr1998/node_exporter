...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-yasm --enable-openssl --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-encoders --disable-decoders --enable-decoder='aac*' --enable-decoder=aac_latm --enable-decoder='pcm*' --enable-decoder=flv --enable-decoder='h264*' --enable-decoder=hevc --enable-decoder='mp3*' --enable-decoder='mpeg*' --disable-hwaccels --disable-muxers --disable-demuxers --enable-demuxer='aac*' --enable-demuxer='pcm*' --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mp3 --enable-demuxer='mpeg*' --enable-demuxer=rtsp --enable-muxer=rtp --enable-muxer=flv --enable-muxer=mpegts --enable-demuxer=hevc --disable-parsers --enable-parser='aac*' --enable-parser='h264*' --enable-parser='mpeg*' --enable-parser=hevc --disable-bsfs --disable-protocols --enable-protocol=async --enable-protocol=file --enable-protocol=crypto --enable-protocol=ffrtmphttp --enable-protocol='rtmp*' --enable-protocol=http --enable-protocol=https --enable-protocol=rtp --enable-protocol=httpproxy --enable-protocol=udp --enable-protocol=tcp --enable-openssl --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --disable-linux-perf --disable-bzlib --disable-asm --disable-x86asm --prefix=/home/lap13588/DataFolder/utils_libs/ijkplayer/android/contrib/build/ffmpeg-arm64/output --cross-prefix=aarch64-linux-android- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/home/lap13588/DataFolder/utils_libs/ijkplayer/android/contrib/build/openssl-arm64/output/include ' --extra-ldflags=' -L/home/lap13588/DataFolder/utils_libs/ijkplayer/android/contrib/build/openssl-arm64/output/lib -lssl -lcrypto '"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/home/lap13588/DataFolder/utils_libs/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/home/lap13588/DataFolder/utils_libs/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
